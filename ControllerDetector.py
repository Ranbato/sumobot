...
print("There is {0} joystick/s".format(str(joystick_count)))
...
print(f"There is {str(axes)} axes")
print(f"There is {str(buttons)} button/s")
print(f"There is {str(hats)} hat/s")
